...
<img src="./images/demo.png" alt="Snake Game" style="float: right; margin-right: 50px" width="45%"/> <img src="./images/demo.gif" alt="Snake Game GIF" style="float: left; margin-left: 50px" width="45%"/>
