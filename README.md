...
<img src="./images/demo.png" alt="Snake Game" style="float: left; margin-right: 10px" width="40%"/>
<img src="./images/demo.gif" alt="Snake Game GIF" style="float: left; margin-right: 10px" width="40%"/>
