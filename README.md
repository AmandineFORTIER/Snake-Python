...
<img src="./images/demo.png" alt="Snake Game" style="float: right; margin-right: 10px" width="30%"/>
<img src="./images/demo.gif" alt="Snake Game GIF" style="float: left; margin-right: 10px" width="30%"/>
